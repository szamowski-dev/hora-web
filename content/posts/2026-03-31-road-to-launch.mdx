...
It's been five days since I [started building hora](/blog/2026-03-26-building-hora/), and the app has gone from prototype to something I genuinely use every day. A lot happened since [the first 48-hour sprint](/blog/native-macos-google-calendar-app-48-hours/). Here's an honest update on where things stand.
