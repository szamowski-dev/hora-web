...
- **Push sync for Google Calendar** — no 5-minute polling lag. When someone moves a meeting in their browser, it should land on your Mac within seconds. (How that works — channels, watch APIs, APNs — is its own [post](/blog/2026-04-16-from-polling-to-push/).)
