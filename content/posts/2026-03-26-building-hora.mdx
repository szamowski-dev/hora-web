...
I'm working toward an initial release on the Mac App Store and TestFlight. Read about [what happened in the first 48 hours](/blog/native-macos-google-calendar-app-48-hours/) or follow the progress on [X](https://x.com/moto_szama).
