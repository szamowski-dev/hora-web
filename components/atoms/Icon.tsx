...
const icons: Record<IconName, IconDefinition> = {
  ...
  mastodon: {
    rendering: "fill",
    content: (
      <path d="M21.6 8.2c0-3.6-2.4-4.7-2.4-4.7C18 2.9 15.8 2.6 13.5 2.6h-.1c-2.3 0-4.5.3-5.7.9 0 0-2.3 1.1-2.3 4.7v3.4c0 3.9.6 7.5 4.7 8.6 1.9.5 3.5.6 4.8.5 2.4-.1 3.7-.8 3.7-.8l-.1-1.7s-1.7.5-3.6.5c-1.9-.1-3.9-.2-4.2-2.5v-.6c4 1 7.4.4 8.3.3 2.6-.3 4.9-1.9 5.2-3.4.4-2.3.4-5.7.4-5.7Zm-3.2 5.3h-2V8.6c0-1-.4-1.6-1.3-1.6-1 0-1.4.6-1.4 1.8v2.7h-2V8.8c0-1.2-.5-1.8-1.4-1.8-.9 0-1.3.5-1.3 1.6v4.9h-2V8.4c0-1 .3-1.8.8-2.4.5-.6 1.2-.9 2.1-.9 1 0 1.8.4 2.3 1.2l.5.8.5-.8c.5-.8 1.3-1.2 2.3-1.2.9 0 1.6.3 2.1.9.5.6.8 1.4.8 2.4v5.1Z" />
    ),
  },
  discord: {
    content: (
